...
namespace CircularScrollView
{
    public class FlipPageCircularScrollView : UICircularScrollView
    {
        ...
        protected new Action<GameObject,int> m_FuncOnClickCallBack;
        ...
        public override void SetToPageIndex(int index)
        {
            ...
            {
                Func(m_FuncOnClickCallBack,m_CellInfos[m_NowIndex].obj, m_NowIndex);
            }
        }
        ...
        //翻页时的回调
        private void Func(Action<GameObject,int> Func,GameObject obj, int index)
        {
            if (Func == null)
                return;
